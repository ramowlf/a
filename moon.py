...
TOKEN = '7450134170:AAEHoz6-NOD4FFfnEbRFPraeQl1Oa1c_iPc'
...
def send_key(message):
    try:
        ...
        channel_username = '@aspectmod'
        if not is_user_in_channel(user_id, channel_username):
            bot.reply_to(message, "Anahtar alabilmek için önce @aspectmod kanalımıza katılmanız gerekmektedir.", parse_mode="Markdown")
            return
        ...
        response = requests.get("https://korsan.tsgmods.com.tr/2SyAmh0ND7ZMKjPamk.php")
        ...
        bot.send_message(-1002154525216, log_message)  
